...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20241127025618_longtelefono")]
    partial class longtelefono
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Rol", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("980c093b-a0a8-46f2-8d98-437aa1ec2b49"),
                            RolName = "Administrador"
                        },
                        new
                        {
                            Id = new Guid("7d46913e-7678-4541-bd3b-b1a1882058aa"),
                            RolName = "Usuario"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Pedido", b =>
                {
                    b.HasOne("Domain.Usuario", "Usuario")
                        .WithOne()
                        .HasForeignKey("Domain.Pedido", "UsuarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
